...
func TestShowStatusReportsRuntimeConnectionTLSAndQueryMetrics(t *testing.T) {
	...
	for _, name := range []string{"Connections", "Threads_connected", "Max_used_connections", "Questions", "Threads_running", "Ssl_accepts", "Ssl_cipher", "Ssl_version", "Gbaselite_storage_state", "Gbaselite_go_managed_bytes", "Gbaselite_heap_bytes", "Gbaselite_gc_cycles", "Gbaselite_goroutines", "Gbaselite_max_procs"} {
